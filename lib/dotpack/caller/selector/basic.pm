  ...
  if ($opts{'skip-usual'})
    {
      ...
      $opts{skip} .= join (',', qw (DR_HOOK ABOR1_SFX ABOR1 WRSCMR SC2PRG VEXP NEW_ADD_FIELD_3D ADD_FIELD_3D FMLOOK_LL FIELD_NEW FIELD_DELETE
                                    ...
                                    TRIDIA LFAPRECI PPP2DUST GET_LUOUT ALLOCATE DEALLOCATE PUT GET SAVE_INPUTS GET_FRAC_N DGEMM SGEMM ABOR1_ACC GETENV 
                                    MM_PREFETCH IEEE_GET_HALTING_MODE IEEE_SET_HALTING_MODE));
    }
